...
public class PutongguanliyuanController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		PutongguanliyuanEntity u = putongguanliyuanService.selectOne(new EntityWrapper<PutongguanliyuanEntity>().eq("guanliyuanzhanghao", username));
		if(u==null || !u.getMima().equals(password)) {
			return R.error("账号或密码不正确");
		}
		String token = tokenService.generateToken(u.getId(), username,"putongguanliyuan",  "管理员" );
    ...
    public R register(@RequestBody PutongguanliyuanEntity putongguanliyuan){
    	...
    	PutongguanliyuanEntity u = putongguanliyuanService.selectOne(new EntityWrapper<PutongguanliyuanEntity>().eq("guanliyuanzhanghao", putongguanliyuan.getGuanliyuanzhanghao()));
		if(u!=null) {
